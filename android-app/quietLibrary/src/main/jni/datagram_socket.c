...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeCreate(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeBind(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeClose(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.datagram.fd);
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeConnect(
        JNIEnv *env, jobject This, jobject inet_socket_address) {
    jobject inet_addr = (*env)->GetObjectField(env, inet_socket_address, cache.inet_socket_address.inet_address);
    jbyteArray j_addr = (jbyteArray)((*env)->GetObjectField(env, inet_addr, cache.inet_address.addr_bytes));
    jint port = (*env)->GetIntField(env, inet_socket_address, cache.inet_socket_address.port);
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeDisconnect(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.datagram.fd);
...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeReceive(
...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeSend(
    JNIEnv *env, jobject This, jobject datagram_packet) {
    jbyteArray j_buf = (*env)->GetObjectField(env, datagram_packet, cache.datagram_packet.buf);
    jlong offset = (*env)->GetIntField(env, datagram_packet, cache.datagram_packet.offset);
    jlong len = (*env)->GetIntField(env, datagram_packet, cache.datagram_packet.length);
...
JNIEXPORT jobject JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeGetLocal(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.datagram.fd);
...
JNIEXPORT jobject JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeGetRemote(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.datagram.fd);
    struct sockaddr_in local;
    socklen_t local_len = sizeof(local);
...
JNIEXPORT jboolean JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeGetBroadcast(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.datagram.fd);
    int broadcast;
...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeGetReceiveBufferSize(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.datagram.fd);
    int buffer_size;
...
JNIEXPORT jboolean JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeGetReuseAddress(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.datagram.fd);
    int reuse;
...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeGetSendBufferSize(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.datagram.fd);
    int buffer_size;
    socklen_t len = sizeof(buffer_size);
...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeGetSoTimeout(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.datagram.fd);
    int timeout;
...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeGetTrafficClass(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.datagram.fd);
    int class;
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeSetBroadcast(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeSetReceiveBufferSize(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeSetReuseAddress(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeSetSendBufferSize(
        JNIEnv *env, jobject This, jint size) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.datagram.fd);
    socklen_t len = sizeof(size);
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeSetSoTimeout(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_DatagramSocket_nativeSetTrafficClass(
