...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_Socket_nativeCreate(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_Socket_nativeBind(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_Socket_nativeClose(
        JNIEnv *env, jobject This) {
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_Socket_nativeConnect(
        JNIEnv *env, jobject This, jobject inet_socket_address) {
    jobject inet_addr = (*env)->GetObjectField(env, inet_socket_address, cache.inet_socket_address.inet_address);
    jbyteArray j_addr = (jbyteArray)((*env)->GetObjectField(env, inet_addr, cache.inet_address.addr_bytes));
    jint port = (*env)->GetIntField(env, inet_socket_address, cache.inet_socket_address.port);
...
JNIEXPORT jobject JNICALL Java_com_ayush_quietlibrary_Socket_nativeGetLocal(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.socket.fd);
...
JNIEXPORT jobject JNICALL Java_com_ayush_quietlibrary_Socket_nativeGetRemote(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.socket.fd);
    struct sockaddr_in local;
    socklen_t local_len = sizeof(local);
...
JNIEXPORT jboolean JNICALL Java_com_ayush_quietlibrary_Socket_nativeGetKeepAlive(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.socket.fd);
    int keepalive;
...
JNIEXPORT jboolean JNICALL Java_com_ayush_quietlibrary_Socket_nativeGetOOBInline(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.socket.fd);
    int oobinline;
...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_Socket_nativeGetReceiveBufferSize(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.socket.fd);
    int buffer_size;
...
JNIEXPORT jboolean JNICALL Java_com_ayush_quietlibrary_Socket_nativeGetReuseAddress(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.socket.fd);
    int reuse;
...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_Socket_nativeGetSendBufferSize(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.socket.fd);
    int buffer_size;
    socklen_t len = sizeof(buffer_size);
...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_Socket_nativeGetSoLinger(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.socket.fd);
    int linger;
...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_Socket_nativeGetSoTimeout(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.socket.fd);
    int timeout;
...
JNIEXPORT jboolean JNICALL Java_com_ayush_quietlibrary_Socket_nativeGetTcpNoDelay(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.socket.fd);
    int nodelay;
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_Socket_nativeSetKeepAlive(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_Socket_nativeSetOOBInline(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_Socket_nativeSetReceiveBufferSize(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_Socket_nativeSetReuseAddress(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_Socket_nativeSetSendBufferSize(
        JNIEnv *env, jobject This, jint buffer_size) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.socket.fd);
    socklen_t len = sizeof(buffer_size);
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_Socket_nativeSetSoLinger(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_Socket_nativeSetSoTimeout(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_Socket_nativeSetTcpNoDelay(
