...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_SocketOutputStream_nativeWrite(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_SocketOutputStream_nativeClose(
