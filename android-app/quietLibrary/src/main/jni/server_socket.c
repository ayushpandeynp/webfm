...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_ServerSocket_nativeCreate(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_ServerSocket_nativeBind(
...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_ServerSocket_nativeAccept(
        JNIEnv *env, jobject This) {
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_ServerSocket_nativeClose(
        JNIEnv *env, jobject This) {
    jint socket_fd = (*env)->GetIntField(env, This, cache.server_socket.fd);
    lwip_close(socket_fd);
}

JNIEXPORT jobject JNICALL Java_com_ayush_quietlibrary_ServerSocket_nativeGetLocal(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.server_socket.fd);
...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_ServerSocket_nativeGetReceiveBufferSize(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.server_socket.fd);
    int buffer_size;
...
JNIEXPORT jboolean JNICALL Java_com_ayush_quietlibrary_ServerSocket_nativeGetReuseAddress(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.server_socket.fd);
    int reuse;
...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_ServerSocket_nativeGetSoTimeout(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.server_socket.fd);
    int timeout;
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_ServerSocket_nativeSetReceiveBufferSize(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_ServerSocket_nativeSetReuseAddress(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_ServerSocket_nativeSetSoTimeout(
