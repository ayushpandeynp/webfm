...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass localSystemClass =
        (*env)->FindClass(env, "com/ayush/quietlibrary/QuietSystem");
    ...
    jclass localSystemInitExcClass =
        (*env)->FindClass(env, "com/ayush/quietlibrary/ModemException");
    ...
    jclass localInetAddressClass = (*env)->FindClass(env, "com/ayush/quietlibrary/InetAddress");
    cache.inet_address.klass = (jclass)((*env)->NewGlobalRef(env, localInetAddressClass));
    (*env)->DeleteLocalRef(env, localInetAddressClass);

    jclass localInetSocketAddressClass = (*env)->FindClass(env, "com/ayush/quietlibrary/InetSocketAddress");
    ...
    jclass localDatagramPacketClass = (*env)->FindClass(env, "com/ayush/quietlibrary/DatagramPacket");
    ...
    jclass localEncoderProfileClass =
        (*env)->FindClass(env, "com/ayush/quietlibrary/FrameTransmitterConfig");
    ...
    jclass localDecoderProfileClass =
        (*env)->FindClass(env, "com/ayush/quietlibrary/FrameReceiverConfig");
    ...
    jclass localEncoderClass =
        (*env)->FindClass(env, "com/ayush/quietlibrary/BaseFrameTransmitter");
    ...
    jclass localDecoderClass =
        (*env)->FindClass(env, "com/ayush/quietlibrary/BaseFrameReceiver");
    ...
    jclass localComplexClass =
        (*env)->FindClass(env, "com/ayush/quietlibrary/Complex");
    ...
    jclass localFrameStatsClass =
        (*env)->FindClass(env, "com/ayush/quietlibrary/FrameStats");
    ...
    jclass localNetworkInterfaceConfClass = (*env)->FindClass(
        env, "com/ayush/quietlibrary/NetworkInterfaceConfig");
    ...
    jclass localNetworkInterfaceClass = (*env)->FindClass(
        env, "com/ayush/quietlibrary/BaseNetworkInterface");
    ...
    jclass localDatagramClass = (*env)->FindClass(
        env, "com/ayush/quietlibrary/DatagramSocket");
    ...
    jclass localServerSocketClass = (*env)->FindClass(
        env, "com/ayush/quietlibrary/ServerSocket");
    ...
    jclass localSocketClass = (*env)->FindClass(
        env, "com/ayush/quietlibrary/Socket");
    ...
    jclass localInputStreamClass = (*env)->FindClass(
        env, "com/ayush/quietlibrary/SocketInputStream");
    ...
    jclass localOutputStreamClass = (*env)->FindClass(
        env, "com/ayush/quietlibrary/SocketOutputStream");
    ...
    cache.inet_socket_address.inet_address =
        (*env)->GetFieldID(env, cache.inet_socket_address.klass, "addr", "Lcom/ayush/quietlibrary/InetAddress;");
    ...
    cache.datagram_packet.inet_socket_address =
        (*env)->GetFieldID(env, cache.datagram_packet.klass, "addr", "Lcom/ayush/quietlibrary/InetSocketAddress;");
    ...
    cache.frame_stats.ctor =
        (*env)->GetMethodID(env, cache.frame_stats.klass, "<init>", "([Lcom/ayush/quietlibrary/Complex;FFZ)V");

    cache.network_interface_config.encoder_profile =
        (*env)->GetFieldID(env, cache.network_interface_config.klass, "transmitterConfig", "Lcom/ayush/quietlibrary/FrameTransmitterConfig;");

    cache.network_interface_config.decoder_profile =
        (*env)->GetFieldID(env, cache.network_interface_config.klass, "receiverConfig", "Lcom/ayush/quietlibrary/FrameReceiverConfig;");

    cache.network_interface_config.local_address =
        (*env)->GetFieldID(env, cache.network_interface_config.klass, "localAddress", "Lcom/ayush/quietlibrary/InetAddress;");

    cache.network_interface_config.netmask =
        (*env)->GetFieldID(env, cache.network_interface_config.klass, "netmask", "Lcom/ayush/quietlibrary/InetAddress;");

    cache.network_interface_config.gateway =
        (*env)->GetFieldID(env, cache.network_interface_config.klass, "gateway", "Lcom/ayush/quietlibrary/InetAddress;");
...
Java_com_ayush_quietlibrary_QuietInit_nativeLWIPInit(JNIEnv *env, jclass klass) {
    quiet_lwip_init();
}

JNIEXPORT jvm_pointer JNICALL
Java_com_ayush_quietlibrary_QuietSystem_nativeOpen(JNIEnv *env,
        jobject This) {
    return jvm_opaque_pointer(android_system_create(env));
}

JNIEXPORT void JNICALL
Java_com_ayush_quietlibrary_QuietSystem_nativeClose(JNIEnv *env, jobject This) {
...
JNIEXPORT void JNICALL
Java_com_ayush_quietlibrary_QuietSystem_nativeOpenOpenSL(JNIEnv *env,
                                                          jobject This) {
    jvm_pointer j_sys = (*env)->GetLongField(env, This, cache.system.ptr);
    quiet_android_system *sys = (quiet_android_system *)recover_pointer(j_sys);
...
JNIEXPORT void JNICALL
Java_com_ayush_quietlibrary_QuietSystem_nativeOpenLoopback(JNIEnv *env,
        jobject This) {
    jvm_pointer j_sys = (*env)->GetLongField(env, This, cache.system.ptr);
    quiet_android_system *sys = (quiet_android_system *)recover_pointer(j_sys);
