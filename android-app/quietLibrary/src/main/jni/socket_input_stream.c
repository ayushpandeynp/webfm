...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_SocketInputStream_nativeRead(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_SocketInputStream_nativeClose(
...
JNIEXPORT jint JNICALL Java_com_ayush_quietlibrary_SocketInputStream_nativeAvailable(
        JNIEnv *env, jobject This) {
    jint lwip_fd = (*env)->GetIntField(env, This, cache.input_stream.fd);
