...
JNIEXPORT jvm_pointer JNICALL Java_com_ayush_quietlibrary_FrameTransmitterConfig_nativeOpen(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_FrameTransmitterConfig_nativeFree(
...
JNIEXPORT jvm_pointer JNICALL Java_com_ayush_quietlibrary_FrameReceiverConfig_nativeOpen(
    JNIEnv *env, jobject This, jstring j_profiles, jstring j_key) {
    const char *profiles = (*env)->GetStringUTFChars(env, j_profiles, 0);
    const char *key = (*env)->GetStringUTFChars(env, j_key, 0);
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_FrameReceiverConfig_nativeFree(
    JNIEnv *env, jobject This) {
