...
JNIEXPORT jvm_pointer JNICALL Java_com_ayush_quietlibrary_BaseFrameTransmitter_nativeOpen(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_BaseFrameTransmitter_nativeTerminate(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_BaseFrameTransmitter_nativeClose(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_BaseFrameTransmitter_nativeFree(
        JNIEnv *env, jobject This) {
    jvm_pointer j_enc = (*env)->GetLongField(env, This, cache.encoder.ptr);
    quiet_android_encoder *enc = (quiet_android_encoder *)recover_pointer(j_enc);
...
JNIEXPORT jlong JNICALL Java_com_ayush_quietlibrary_BaseFrameTransmitter_nativeSend(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_BaseFrameTransmitter_nativeSetBlocking(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_BaseFrameTransmitter_nativeSetNonblocking(
        JNIEnv *env, jobject This) {
    jvm_pointer j_enc = (*env)->GetLongField(env, This, cache.encoder.ptr);
    quiet_android_encoder *enc = (quiet_android_encoder *)recover_pointer(j_enc);
...
JNIEXPORT jlong JNICALL Java_com_ayush_quietlibrary_BaseFrameTransmitter_nativeClampFrameLen(
...
JNIEXPORT jlong JNICALL Java_com_ayush_quietlibrary_BaseFrameTransmitter_nativeGetFrameLength(
        JNIEnv *env, jobject This) {
    jvm_pointer j_enc = (*env)->GetLongField(env, This, cache.encoder.ptr);
    quiet_android_encoder *enc = (quiet_android_encoder *)recover_pointer(j_enc);
