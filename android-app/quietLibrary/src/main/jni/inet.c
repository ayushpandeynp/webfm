...
JNIEXPORT jstring JNICALL Java_com_ayush_quietlibrary_InetAddress_byte2str(
...
JNIEXPORT jbyteArray JNICALL Java_com_ayush_quietlibrary_InetAddress_str2byte(
