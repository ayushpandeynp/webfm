...
JNIEXPORT jvm_pointer JNICALL Java_com_ayush_quietlibrary_BaseNetworkInterface_nativeOpen(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_BaseNetworkInterface_nativeTerminate(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_BaseNetworkInterface_nativeClose(
...
JNIEXPORT void JNICALL Java_com_ayush_quietlibrary_BaseNetworkInterface_nativeFree(
        JNIEnv *env, jobject This) {
    jvm_pointer j_intf = (*env)->GetLongField(env, This, cache.network_interface.ptr);
    quiet_lwip_android *e = (quiet_lwip_android *)recover_pointer(j_intf);
    free(e);
